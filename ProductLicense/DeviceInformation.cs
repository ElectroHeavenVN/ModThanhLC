...
internal class DeviceInformation
{
    ...
    public static string GetHardwareInformation() => "thanhlc.com" + HWID.getHWID(true, false, true, false);
    ...
    public static string GetIpv4() => Dns.GetHostByName(Dns.GetHostName()).AddressList[0].ToString();
