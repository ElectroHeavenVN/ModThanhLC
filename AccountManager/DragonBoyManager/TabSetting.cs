...
namespace DragonBoyManager
{
    public partial class TabSetting : UserControl
    {
        ...
        {
            File.WriteAllText(contents: checkBox1.Checked + "|" + checkBox2.Checked + "|" + checkBox3.Checked + "|" + checkBox4.Checked + "|" + checkBox5.Checked + "|" + checkBox6.Checked + "|" + checkBox7.Checked + "|" + checkBox8.Checked + "|" + checkBox9.Checked + "|" + checkBox16.Checked + "|" + checkBox10.Checked + "|" + checkBox11.Checked + "|" + checkBox12.Checked + "|" + checkBox13.Checked + "|" + checkBox14.Checked + "|" + checkBox15.Checked + "|" + checkBox17.Checked + "|" + textBox1.Text, path: PathGraphic);
        }
        ...
        public void LoadFunctionSetting()
        {
            if (File.Exists(PathSetting))
            {
                ...
                if (array[18] != null && array[18] != string.Empty)
        ...
        public void SaveFunctionSetting()
        {
            if (comboBox5.Text != null && !(comboBox5.Text == string.Empty))
                File.WriteAllText(contents: checkBox34.Checked + "|" + checkBox33.Checked + "|" + checkBox31.Checked + "|" + checkBox32.Checked + "|" + checkBox29.Checked + "|" + checkBox24.Checked + "|" + checkBox30.Checked + "|" + checkBox27.Checked + "|" + checkBox28.Checked + "|" + checkBox26.Checked + "|" + checkBox23.Checked + "|" + checkBox25.Checked + "|" + checkBox22.Checked + "|" + checkBox18.Checked + "|" + checkBox19.Checked + "|" + textBox2.Text + "|" + textBox3.Text + "|" + checkBox20.Checked + "|" + comboBox5.Text.Split('.')[0], path: PathSetting);
        }
