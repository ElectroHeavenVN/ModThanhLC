...
public class GClass8 : GClass6, GInterface6
{
	...
	public GClass8(int id, short px, short py, int templateID, int hp, int maxHp, int s)
	{
		if (gclass20_2 == null)
			gclass20_2 = GClass14.smethod_43("/mainImage/shadowBig.png");
		int_25 = id;
		int_55 = (int_8 = px + 20);
		int_56 = (int_9 = py);
		int_17 = py;
	...
	public void method_29()
	{
		...
		string patch = "/x" + GClass193.int_12 + "/effectdata/" + 109 + "/data";
		try
		{
			gclass194_0.method_4(patch);
			gclass194_0.gclass20_0 = GClass14.smethod_43("/effectdata/" + 109 + "/img.png");
		}
		catch (Exception)
		{
	...
	public void method_37(GClass124 cFocus)
	{
		bool_32 = true;
		gclass6_2 = null;
		gclass124_0 = cFocus;
	...
	public void method_42(GClass124[] cAttack, int[] dame, sbyte type)
	{
		int_12 = 3;
		gclass124_3 = cAttack;
		int_70 = dame;
	...
	public void method_43()
	{
		if (sbyte_17 == 0)
		{
			...
			if (int_60 == 8)
			{
				...
				{
					gclass124_3[i].method_112(int_70[i], 0, false, false);
		...
		if (sbyte_17 == 1)
		{
			...
			if (int_60 == 8)
			{
				...
				{
					GClass89.smethod_0(int_8 + ((int_10 != 1) ? (-45) : 45), int_9 - 25, true, int_70[j], 0, gclass124_3[j], 24);
				}
			}
		}
		if (sbyte_17 != 2)
		...
		if (int_60 == 12)
		{
			...
			{
				gclass124_3[k].method_112(int_70[k], 0, false, false);
				GClass91.smethod_0(102, gclass124_3[k].int_4, gclass124_3[k].int_5, 1);
			}
		}
	}
	...
	public override void paint(GClass193 g)
	{
		...
		if (!bool_14)
		{
			...
			{
				int_68++;
				GClass98.smethod_0(new GClass85((sbyte_17 != 2) ? 22 : 19, int_8 + int_68 * 50, int_9 + 25, 2, 1, -1));
				GClass98.smethod_0(new GClass85((sbyte_17 != 2) ? 22 : 19, int_8 - int_68 * 50, int_9 + 25, 2, 1, -1));
				if (int_68 == 50)
				{
					int_68 = 0;
	...
	public void method_50(GClass6 mobToAttack)
	{
