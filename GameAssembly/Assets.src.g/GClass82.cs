namespace Assets.src.g
{
	public class GClass82
	{
		...
		public void method_1(GClass122 g)
		{
			int w = 32;
			int h = 32;
			int num = ((GClass73.int_8 % 10 > 5) ? 1 : 0);
			if (int_13 > 0)
			{
				w = int_14;
				h = int_15;
			...
			GClass28.smethod_7(g, short_0, int_1, int_9, int_4 + 3 + num, w, h, (int_0 != 1) ? 2 : 0, GClass188.int_6);
		}
		...
		{
			GClass97.smethod_0(60, int_9, int_4 + 3 + ((GClass73.int_8 % 10 > 5) ? 1 : 0), 1);
		}
