...
public class GClass0
{
	...
	public bool method_0()
	{
		if (gclass5_0 != null)
		{
			...
			{
				if (gclass5_0[i] != null && gclass5_0[i].method_0().StartsWith("Set"))
					return true;
			}
		}
		return false;
	...
	public bool method_1()
	{
		for (int i = 0; i < gclass5_0.Length; i++)
		{
			if (gclass5_0[i].gclass151_0.int_0 == 93)
				return true;
		}
		return false;
	}
	...
	{
		return (!method_1()) ? string.Empty : ((GClass62.int_0 != 0) ? " [Expr]" : " [HSD]");
	}

	public void method_3(GClass193 g, int p1, int p2, int p3)
	{
		if (GClass66.smethod_0().bool_8 || p3 < 4 || GClass66.smethod_0().bool_20)
			return;
		if (p3 > 8)
			p3 = 8;
		if (p3 < 0)
		...
		if (p3 < 4 && p3 != 2)
		{
			if (p3 != 1)
			{
				for (int i = 0; i < 2; i++)
				{
					...
					{
						int num = p1 - 17 + method_4(GClass14.int_8 + array3[i] - j * 4);
						int num2 = p2 - 12 + method_5(GClass14.int_8 + array4[i] - j * 4);
						g.method_16(GClass42.smethod_0().method_23(this) ? 16776960 : int_50[0][j]);
				...
				for (int k = 2; k < 4; k++)
				{
					...
					{
						int num3 = p1 - 17 + method_4(GClass14.int_8 + array3[k] - l * 4);
						int num4 = p2 - 12 + method_5(GClass14.int_8 + array4[k] - l * 4);
						g.method_16((!GClass42.smethod_0().method_23(this)) ? int_50[1][l] : 16776960);
			...
			for (int m = 0; m < 2; m++)
			{
				...
				{
					int num5 = p1 - 17 + method_4(GClass14.int_8 + array3[m] - n * 4);
					int num6 = p2 - 12 + method_5(GClass14.int_8 + array4[m] - n * 4);
					g.method_16((!GClass42.smethod_0().method_23(this)) ? ((p3 < 7) ? int_50[array[p3 - 1]][n] : 16777215) : 16776960);
		...
		for (int num7 = 0; num7 < 4; num7++)
		{
			...
			{
				int num9 = p1 - 17 + method_4(GClass14.int_8 + array3[num7] - num8 * 4);
				int num10 = p2 - 12 + method_5(GClass14.int_8 + array4[num7] - num8 * 4);
				int num11 = int_50[array[p3 - 1]][num8];
				for (int num12 = 0; num12 < gclass5_0.Length; num12++)
				{
					int num13 = 0;
					if (gclass5_0[num12].int_0 <= 0)
						continue;
					if (gclass5_0[num12].gclass151_0.int_0 != 102)
					{
						if (gclass5_0[num12].gclass151_0.int_0 == 107)
							num13 = gclass5_0[num12].int_0;
					}
					else
						num13 = gclass5_0[num12].int_0;
					if (num13 >= 7)
				...
				g.method_16(GClass42.smethod_0().method_23(this) ? 16776960 : num11);
	...
	{
		int_43 = GClass14.gclass113_0.method_131(this);
	}
	...
	public void method_8(int x, int y, int upgrade, GClass193 g)
	{
		int num = GClass167.int_42 - 2;
		int num2 = 0;
		int num3 = ((upgrade >= 4) ? ((upgrade < 8) ? 1 : ((upgrade < 12) ? 2 : ((upgrade > 14) ? 4 : 3))) : 0);
		for (int i = num2; i < int_51.Length; i++)
		{
			int num4 = x - num / 2 + method_10(GClass14.int_8 - i * 4);
			int num5 = y - num / 2 + method_9(GClass14.int_8 - i * 4);
		...
		if (upgrade == 4 || upgrade == 8)
		{
			...
			{
				int num6 = x - num / 2 + method_10(GClass14.int_8 - num * 2 - j * 4);
				int num7 = y - num / 2 + method_9(GClass14.int_8 - num * 2 - j * 4);
		...
		if (upgrade != 1 && upgrade != 4 && upgrade != 8)
		{
			...
			{
				int num8 = x - num / 2 + method_10(GClass14.int_8 - num * 2 - k * 4);
				int num9 = y - num / 2 + method_9(GClass14.int_8 - num * 2 - k * 4);
		...
		if (upgrade != 1 && upgrade != 4 && upgrade != 8 && upgrade != 12 && upgrade != 2 && upgrade != 5 && upgrade != 9)
		{
			...
			{
				int num10 = x - num / 2 + method_10(GClass14.int_8 - num - l * 4);
				int num11 = y - num / 2 + method_9(GClass14.int_8 - num - l * 4);
		...
		if (upgrade != 1 && upgrade != 4 && upgrade != 8 && upgrade != 12 && upgrade != 2 && upgrade != 5 && upgrade != 9 && upgrade != 13 && upgrade != 3 && upgrade != 6 && upgrade != 10 && upgrade != 15)
		{
			...
			{
				int num12 = x - num / 2 + method_10(GClass14.int_8 - num * 3 - m * 4);
				int num13 = y - num / 2 + method_9(GClass14.int_8 - num * 3 - m * 4);
	...
	public bool method_11(int id)
	{
		for (int i = 0; i < gclass5_0.Length; i++)
		{
			...
			if (gClass != null && gClass.gclass151_0.int_0 == id)
				return true;
		}
		return false;
	}

	public GClass0 method_12()
	{
		GClass0 gClass = new GClass0();
		gClass.gclass203_0 = gclass203_0;
		if (gclass122_0 != null)
		{
			...
			for (int i = 0; i < gclass122_0.method_2(); i++)
			{
				...
				gClass2.gclass151_0 = ((GClass5)gclass122_0.method_3(i)).gclass151_0;
				gClass2.int_0 = ((GClass5)gclass122_0.method_3(i)).int_0;
				gClass.gclass122_0.method_0(gClass2);
			}
		}
	...
	{
		if ((0 <= gclass203_0.sbyte_0 && gclass203_0.sbyte_0 < 6) || gclass203_0.sbyte_0 == 32 || gclass203_0.sbyte_0 == 35 || gclass203_0.sbyte_0 == 11 || gclass203_0.sbyte_0 == 23)
			return true;
		return false;
	}
	...
	{
		if (gclass203_0.sbyte_2 < 10 || gclass203_0.sbyte_0 >= 10)
	...
	{
		if (gclass203_0.sbyte_2 < 1 || gclass203_0.sbyte_2 >= 20)
		{
			if (gclass203_0.sbyte_2 < 20 || gclass203_0.sbyte_2 >= 40)
			{
				if (gclass203_0.sbyte_2 >= 40 && gclass203_0.sbyte_2 < 50)
					return 12;
				if (gclass203_0.sbyte_2 >= 50 && gclass203_0.sbyte_2 < 60)
					return 14;
				return 16;
			}
			return 8;
