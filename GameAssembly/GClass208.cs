...
public class GClass208
{
	...
	private static int smethod_1(string string_2, string string_3)
	{
		if (int_0 != 0)
		{
			...
			if (int_0 != 0)
			{
				GClass92.smethod_2("CANNOT SEND SMS " + string_2 + " WHEN SENDING " + string_1);
				return -1;
			}
		}
		string_1 = string_2;
	...
	{
		int num = GClass30.smethod_0();
		GClass92.smethod_0("vao sms ko " + num);
		if (num >= 0)
		{
			bool_0 = true;
			bool_1 = true;
			GClass30.smethod_2(string_3, string_2, num);
	...
	private static void smethod_4()
	{
		if (bool_1)
		{
			if (GClass30.smethod_6() == 1)
				Screen.orientation = ScreenOrientation.LandscapeLeft;
			else if (GClass30.smethod_6() != -1)
			{
				if (GClass30.smethod_6() == 0)
					Screen.orientation = ScreenOrientation.AutoRotation;
				else if (GClass30.smethod_6() == 2)
				{
					Screen.orientation = ScreenOrientation.LandscapeRight;
				}
				else if (GClass30.smethod_6() == 3)
				{
