...
{
	public class GClass173 : GInterface2
	{
		private enum Enum0
		{
		...
		public GClass173(TcpClient tcpClient)
		{
			if (tcpClient == null)
		...
		public GClass173(string proxyHost)
		{
		...
		public GClass173(string proxyHost, int proxyPort)
		{
			if (!string.IsNullOrEmpty(proxyHost))
			{
		...
		public GClass173(string proxyHost, string proxyUserName, string proxyPassword)
		{
			if (string.IsNullOrEmpty(proxyHost))
				throw new ArgumentNullException("proxyHost");
		...
		public GClass173(string proxyHost, int proxyPort, string proxyUserName, string proxyPassword)
		{
			if (!string.IsNullOrEmpty(proxyHost))
			{
				if (proxyPort > 0 && proxyPort <= 65535)
		...
		public TcpClient CreateConnection(string destinationHost, int destinationPort)
		{
			if (!string.IsNullOrEmpty(destinationHost))
			{
				...
				{
					throw new GException0(string.Format(CultureInfo.InvariantCulture, "Connection to proxy host {0} on port {1} failed.", Class3.smethod_0(tcpClient_0), Class3.smethod_1(tcpClient_0)), innerException);
				}
			}
		...
		private void backgroundWorker_0_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			if (eventHandler_0 != null)
				eventHandler_0(this, new GEventArgs0(exception_0, bool_0, (TcpClient)e.Result));
		}
	}
}
