...
public class GClass50
{
	...
	public static int smethod_5(int dx, int dy)
	{
		...
		if (dx != 0)
		{
			num = smethod_4(GClass118.smethod_0((dy << 10) / dx));
			if (dy >= 0 && dx < 0)
				num = 180 - num;
			if (dy < 0 && dx < 0)
				num = 180 + num;
	...
	{
		return gclass2_0.method_1(a);
	}

	public static int smethod_21(int a, int b)
	{
		int num = a + gclass2_0.method_1(b - a);
		if (smethod_20(2) == 0)
			num = -num;
		return num;
	}
	...
	{
		int num;
		for (num = 0; num == 0; num = gclass2_0.method_0() % a)
		{
		}
		return num;
	}
	...
	public static int smethod_26(int a)
	{
		...
		while (GClass118.smethod_0(num2 - num) > 1);
		return num;
	}
	...
	public static string smethod_32(long number)
	{
		...
		empty2 = mResources.billion;
		long num3 = number % 1000000000L / 10000000L;
		number /= 1000000000L;
		empty = number + "";
		if (num3 >= 10L)
		{
