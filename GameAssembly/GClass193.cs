...
public class GClass193
{
	...
	private void method_0(string string_0, Texture texture_0)
	{
		if (hashtable_0.Count > 400)
			hashtable_0.Clear();
		if (texture_0.width * texture_0.height < GClass14.int_10 * GClass14.int_11)
	...
	public int method_6()
	{
		return GClass167.int_22;
	}

	public int method_7()
	{
		return GClass167.int_23;
	}

	public int method_8()
	{
		return GClass167.int_6;
	}

	public int method_9()
	{
		return GClass167.int_7;
	}
	...
	public void method_11(int x1, int y1, int x2, int y2)
	{
		...
		{
			GClass51.smethod_0("Data/Errors/drawLine.txt", ex.ToString());
		}
	}
	...
	public void method_19(string s, float x, float y, GUIStyle style)
	{
		...
		if (bool_0)
			GUI.BeginGroup(new Rect(num, num2, num3, num4));
		GUI.Label(new Rect(x - (float)num, y - (float)num2, GClass155.float_0, 100f), s, style);
		if (bool_0)
			GUI.EndGroup();
	}
	...
	public void method_23(GClass20 arg0, int x0, int y0, int w0, int h0, int arg5, int x, int y, int arg8)
	{
		if (arg0 != null)
		{
			x *= int_12;
	...
	public void method_24(GClass20 arg0, int x0, int y0, int w0, int h0, int arg5, float x, float y, int arg8)
	{
		if (arg0 != null)
		{
			x *= (float)int_12;
	...
	public void method_25(GClass20 arg0, int x0, int y0, int w0, int h0, int arg5, int x, int y, int arg8, bool isClip)
	{
		method_23(arg0, x0, y0, w0, h0, arg5, x, y, arg8);
	}

	public void method_26(GClass20 image, int x0, int y0, int w, int h, int transform, float x, float y, int anchor)
	{
		if (image == null)
			return;
		if (bool_1)
	...
	public void method_27(GClass20 image, float x0, float y0, int w, int h, int transform, int x, int y, int anchor)
	{
		if (image == null)
			return;
		if (bool_1)
	...
	public void method_28(GClass20 image, float x0, float y0, int w, int h, int transform, float x, float y, int anchor)
	{
	...
	public void method_29(GClass20 image, float x0, float y0, int w, int h, int transform, int x, int y, int anchor)
	{
		...
		if (texture2D == null)
		{
			texture2D = GClass20.smethod_3(image, (int)x0, (int)y0, w, h, transform).texture2D_0;
			method_0(text, texture2D);
		}
		int num = 0;
		int num2 = 0;
	...
	public void method_30(GClass20 image, float x, float y)
	{
		x *= (float)int_12;
		y *= (float)int_12;
	...
	public void method_31(GClass20 image, int x, int y, int anchor)
	{
		if (((image == GClass167.gclass20_28 || image == GClass167.gclass20_29 || image == GClass167.gclass20_39 || image == GClass167.gclass20_40 || image == GClass167.gclass20_9 || image == GClass167.gclass20_10 || image == GClass167.gclass20_30 || image == GClass167.gclass20_16 || image == GClass167.gclass20_17 || image == GClass167.gclass20_18 || image == GClass167.gclass20_19 || image == GClass167.gclass20_11 || image == GClass167.gclass20_31 || image == GClass167.gclass20_34 || image == GClass167.gclass20_28 || image == GClass167.gclass20_29 || image == GClass167.gclass20_14 || image == GClass167.gclass20_15 || image == GClass167.gclass20_33) && GClass66.smethod_0().bool_17) || (image == GClass190.gclass20_0 && (GClass66.smethod_0().bool_8 || GClass66.smethod_0().bool_9)) || (image == GClass137.gclass20_12 && GClass66.smethod_0().bool_10))
			image = null;
		if (image != null)
			method_23(image, 0, 0, smethod_0(image), smethod_1(image), 0, x, y, anchor);
	}

	public void method_32(GClass20 image, int x, int y, int anchor)
	{
		if (image != null)
			method_23(image, 0, 0, image.texture2D_0.width, image.texture2D_0.height, 0, x, y, anchor);
	}

	public void method_33(GClass20 image, int x, int y)
	{
		if (image != null)
			method_23(image, 0, 0, smethod_0(image), smethod_1(image), 0, x, y, int_4 | int_2);
	}

	public void method_34(GClass20 image, float x, float y, int anchor)
	{
		if (image != null)
	...
	public void method_39(GClass20 image, int x, int y, int w, int h, int tranform)
	{
		GUI.color = Color.red;
		x *= int_12;
		y *= int_12;
	...
	public void method_40(GClass20 image, int x, int y)
	{
		x *= int_12;
		y *= int_12;
		if (image != null)
	...
	public static int smethod_0(GClass20 image)
	{
		return image.method_0();
	}

	public static int smethod_1(GClass20 image)
	{
	...
	public static GClass20 smethod_3(GClass20 img0, float level, int rgb)
	{
		int num = rgb & 0xFF;
		int num2 = (rgb >> 8) & 0xFF;
		int num3 = (rgb >> 16) & 0xFF;
		...
		GClass20 gClass = GClass20.smethod_4(img0.method_3(), img0.method_4());
		gClass.texture2D_0.SetPixels(pixels);
		GClass20.smethod_26(gClass.texture2D_0);
		gClass.texture2D_0.Apply();
		GClass92.smethod_3("BLEND ----------------------------------------------------");
		return gClass;
	}
	...
	public void method_41(GClass20 imgTrans, int x, int y, int w, int h)
	{
		method_20(0, 0.5f);
	...
	public static int smethod_7(GClass20 img)
	{
		return img.int_5;
	}

	public static int smethod_8(GClass20 img)
	{
		return img.int_6;
	}
	...
	public void method_44(GClass122 totalLine)
	{
		...
		{
			GClass207 gClass = (GClass207)totalLine.method_3(i);
	...
	public void method_45(GClass193 g, int x, int y, int xTo, int yTo, int nLine, int color)
	{
		GClass122 gClass = new GClass122();
		for (int i = 0; i < nLine; i++)
		{
			gClass.method_0(new GClass207(x, y, xTo + i, yTo + i, color));
		}
		g.method_44(gClass);
	}

	internal void method_46(GClass26 gclass26_0, int int_28, int int_29, int int_30, int int_31, int int_32, int int_33, int int_34, int int_35)
	{
