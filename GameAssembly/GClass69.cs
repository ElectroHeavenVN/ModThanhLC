...
public class GClass69
{
	...
	{
		GClass36.smethod_0("Init Scale GUI: Screen.w=" + Screen.width + " Screen.h=" + Screen.height);
	...
	public static void smethod_1()
	{
		if (bool_0)
		{
			...
			float num3 = ((!(num >= float_0 / float_1)) ? ((float)Screen.width / float_0) : ((float)Screen.height / float_1));
