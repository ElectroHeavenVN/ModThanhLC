...
public class GClass22
{
	...
	public static void smethod_0(GClass109.GClass111 ac)
	{
	}
	...
	public static void smethod_4(int[] musicID, int[] sID)
	{
		if (gameObject_0 == null && audioClip_0 == null)
		{
			...
			for (int i = 0; i < gameObject_0.Length; i++)
			{
				smethod_7((i < int_3) ? ("/music/" + i) : ("/sound/" + (i - int_3)), i);
			}
		}
	}
	...
	{
		if (GClass73.bool_21 && !(audioSource_2 == null))
		{
	...
	private static void smethod_24(string string_1, int int_4)
	{
		if (int_0 == 0)
		{
			...
			if (i != 100)
				GClass36.smethod_1("Load Audio " + string_1 + " done in " + i * 5 + "ms");
			else
				GClass36.smethod_2("TOO LONG FOR LOAD AUDIO " + string_1);
		}
		else
			GClass36.smethod_2("CANNOT LOAD AUDIO " + string_1 + " WHEN LOADING " + string_0);
	}
