public class GClass24
{
	...
	public GClass88 gclass88_0 = new GClass88("vecInfo chientruong");

	public GClass24(int type_PB, short idmapPaint, string nameTeam1, string nameTeam2, int maxPoint, short timeSecond)
	{
		int_0 = type_PB;
		short_0 = idmapPaint;
		string_0 = nameTeam1;
