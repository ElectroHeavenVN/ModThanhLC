...
public class GClass78
{
	...
	private static string veSmgtgadI;
	...
	public static void smethod_0(GClass29.GClass31 ac)
	{
	}
	...
	{
		if (GClass39.bool_21 && !(audioSource_2 == null))
		{
	...
	public static void smethod_20(int id, float volume)
	{
		if (GClass39.bool_21)
		{
			if (id == GClass29.int_2)
				smethod_12(id, volume + 0.2f);
			else if (!(audioSource_2 == null) && !smethod_22(id))
			{
	...
	private static void smethod_24(string string_0, int int_4)
	{
		if (int_0 != 0)
		{
			GClass5.smethod_2("CANNOT LOAD AUDIO " + string_0 + " WHEN LOADING " + veSmgtgadI);
			return;
		}
		veSmgtgadI = string_0;
		int_1 = int_4;
		...
		if (i == 100)
		{
			GClass5.smethod_2("TOO LONG FOR LOAD AUDIO " + string_0);
			return;
		}
		GClass5.smethod_1("Load Audio " + string_0 + " done in " + i * 5 + "ms");
	}

	private static void smethod_25(string string_0, int int_4)
	{
		audioClip_0[int_4] = (AudioClip)Resources.Load(string_0, typeof(AudioClip));
