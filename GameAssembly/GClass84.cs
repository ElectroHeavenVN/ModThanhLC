public class GClass84
{
	...
	public GClass125 gclass125_1;

	public GClass125 gclass125_2;
	...
	public GClass84(int x, int y)
	{
		int_0 = x;
		int_1 = y;
	}

	public GClass84(int x, int y, int goc)
	{
		int_0 = x;
		int_1 = y;
		int_22 = goc;
	...
	public void method_2(GClass76 g)
	{
		if (!bool_0)
		{
			...
			if (bool_1 && int_16 >= int_21)
				num = 1;
			gclass125_0[int_7].method_0(int_19 / 2 + num, int_0, int_1, int_15, 3, g);
		}
	}
	...
	{
		int_19 = method_4(GClass56.smethod_5(dx, dy));
		int num = 0;
		int num2 = 0;
		int num3 = GClass56.smethod_25(dx, dy) / int_4;
		if (num3 == 0)
			num3 = 1;
		num = dx / num3;
		num2 = dy / num3;
	...
	public void method_7(int toX, int toY)
	{
		...
		int dy = toY - int_1;
		if (num > 1)
			int_19 = method_4(GClass56.smethod_5(num, dy));
		if (GClass56.smethod_28(int_9) > 0)
		{
			if (GClass56.smethod_28(int_0 - toX) < GClass56.smethod_28(int_9))
			{
				int_0 = toX;
				int_9 = 0;
			}
		...
		if (GClass56.smethod_28(int_10) > 0)
		{
			if (GClass56.smethod_28(int_1 - toY) < GClass56.smethod_28(int_10))
			{
				int_1 = toY;
				int_10 = 0;
			}
	...
	public void method_8(GClass76 g, GClass125 frm, int anchor, bool isCountFr)
	{
		if (frm != null)
		{
			int num = frm.int_2 / 3;
