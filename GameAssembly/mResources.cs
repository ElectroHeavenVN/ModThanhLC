...
public class mResources
{
	...
	public static void loadLanguague(sbyte newLanguage)
	{
		...
		{
		case 0:
			GClass149.gclass2_0 = GClass173.smethod_0().method_3("imgTitle", GClass76.int_12);
			GClass103.smethod_0();
			GClass152.string_10 = "https://www.facebook.com/lcthanh172";
			break;
		case 1:
			GClass149.gclass2_0 = GClass173.smethod_0().method_3("imgTitle", GClass76.int_12);
			GClass104.smethod_0();
	...
	{
		return GClass95.smethod_4(str, "#", replacement);
	}
}
