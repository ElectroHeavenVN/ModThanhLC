...
public class mResources
{
	...
	public static void loadLanguague(sbyte newLanguage)
	{
		...
		{
		case 0:
			GClass173.gclass20_0 = GClass66.smethod_0().method_5("imgTitle");
			GClass110.smethod_0();
			GClass170.string_10 = "https://www.facebook.com/lcthanh172";
			break;
		case 1:
			GClass173.gclass20_0 = GClass66.smethod_0().method_5("imgTitle");
			GClass109.smethod_0();
	...
	{
		return GClass138.smethod_4(str, "#", replacement);
	}
}
