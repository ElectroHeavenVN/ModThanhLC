...
namespace ns1
{
	...
	{
		private static GClass190 gclass190_0;

		public static GClass190 smethod_0()
		{
			return (gclass190_0 != null) ? gclass190_0 : (gclass190_0 = new GClass190());
		}
		...
		private List<int> method_1(int int_0, List<int> list_0)
		{
			...
			if (num == int_0)
				return list_0;
			if (!GClass178.smethod_2(num))
				return null;
			List<List<int>> list = new List<List<int>>();
			foreach (GStruct11 item in GClass178.smethod_1(num))
			{
				List<int> list2 = null;
