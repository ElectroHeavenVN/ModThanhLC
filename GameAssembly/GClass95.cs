...
public class GClass95
{
	...
	{
		GClass39.smethod_31(mResources.downloading_data);
	}

	public static int smethod_1(int max)
	{
		return new GClass91().method_1(max);
	}

	public static sbyte[] smethod_2(GClass110 msg)
	{
		try
		{
	...
	public static sbyte[] smethod_3(GClass131 dos)
	{
		...
		{
			GClass5.smethod_2("LOI DOC readByteArray dos  NINJAUTIL");
		}
		return null;
	}
