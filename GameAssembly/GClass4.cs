public class GClass4
{
	...
	public GClass122 gclass122_0 = new GClass122("vecInfo chientruong");

	public GClass4(int type_PB, short idmapPaint, string nameTeam1, string nameTeam2, int maxPoint, short timeSecond)
	{
		int_0 = type_PB;
		short_0 = idmapPaint;
		string_0 = nameTeam1;
