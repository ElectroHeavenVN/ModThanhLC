...
public class GClass120
{
	...
	public static string smethod_2(string fileName)
	{
		...
		{
			GClass5.smethod_0(ex.StackTrace);
		}
		return null;
	}
	...
	{
		return (GClass76.int_12 == 2) ? "Data/GameData/RMS2" : "Data/GameData/RMS1";
	}
	...
	private static void smethod_11(string string_1, sbyte[] sbyte_1)
	{
		...
		fileStream.Write(GClass66.smethod_1(sbyte_1), 0, sbyte_1.Length);
		fileStream.Flush();
		fileStream.Close();
	...
	private static sbyte[] smethod_12(string string_1)
	{
		try
		{
			...
			fileStream.Close();
			GClass66.smethod_0(array);
			return GClass66.smethod_0(array);
		}
		catch (Exception)
		{
			return null;
	...
	public static void smethod_17(string name)
	{
		...
		{
			GClass5.smethod_0("loi xoa RMS --------------------------" + ex.ToString());
		}
	}
