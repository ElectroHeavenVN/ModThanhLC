namespace ns0
{
	public class GClass128
	{
		...
		public void method_1(GClass76 g)
		{
			int w = 32;
			int h = 32;
			int num = ((GClass39.int_8 % 10 > 5) ? 1 : 0);
			if (int_13 > 0)
			{
				w = int_14;
				h = int_15;
			...
			GClass96.smethod_7(g, short_0, int_1, int_9, int_4 + 3 + num, w, h, (int_0 != 1) ? 2 : 0, GClass169.int_6);
		}
		...
		{
			GClass71.smethod_0(60, int_9, int_4 + 3 + ((GClass39.int_8 % 10 > 5) ? 1 : 0), 1);
		}
