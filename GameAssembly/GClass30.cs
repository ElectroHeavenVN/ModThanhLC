...
public class GClass30
{
	...
	public static int smethod_0()
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
			return smethod_1();
		string_0 = GClass69.genum3_0.ToString();
		...
		GClass92.smethod_0(string_0 + "  loai");
		if (!(string_0 == "Unknown") || !(GClass155.float_0 * GClass155.float_1 < 786432f))
			return -1;
		return 0;
	}
	...
	{
		if (GClass69.genum3_0 == GEnum3.const_3 || GClass69.genum3_0 == GEnum3.const_8 || GClass69.genum3_0 == GEnum3.const_11 || GClass69.genum3_0 == GEnum3.const_13)
			return 0;
		return -1;
	}
