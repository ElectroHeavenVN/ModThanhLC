...
namespace AssemblyCSharp.Functions
{
	...
	{
		private static GClass152 gclass152_0;

		public static GClass152 smethod_0()
		{
			return (gclass152_0 != null) ? gclass152_0 : (gclass152_0 = new GClass152());
		}
		...
		private List<int> method_1(int int_0, List<int> list_0)
		{
			...
			if (num == int_0)
				return list_0;
			if (!GClass174.smethod_2(num))
				return null;
			List<List<int>> list = new List<List<int>>();
			foreach (GStruct0 item in GClass174.smethod_1(num))
			{
				List<int> list2 = null;
