...
public class GClass56
{
	...
	public static int smethod_5(int dx, int dy)
	{
		...
		if (dx != 0)
		{
			num = smethod_4(GClass26.smethod_0((dy << 10) / dx));
			if (dy >= 0 && dx < 0)
				num = 180 - num;
			if (dy < 0 && dx < 0)
				num = 180 + num;
	...
	public static int smethod_19(int a, int b)
	{
		if (a == b)
			return a;
		return a + gclass91_0.method_1(b - a);
	}

	public static int smethod_20(int a)
	{
		return gclass91_0.method_1(a);
	}

	public static int smethod_21(int a, int b)
	{
		int num = a + gclass91_0.method_1(b - a);
		if (smethod_20(2) == 0)
			num = -num;
		return num;
	}
	...
	{
		int num;
		for (num = 0; num == 0; num = gclass91_0.method_0() % a)
		{
		}
		return num;
	}
	...
	public static int smethod_26(int a)
	{
		...
		while (GClass26.smethod_0(num2 - num) > 1);
		return num;
	}
