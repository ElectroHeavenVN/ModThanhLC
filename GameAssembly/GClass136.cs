...
public class GClass136 : GInterface1
{
	public bool bool_0;
	...
	public static GClass196 gclass196_0;
	...
	public GClass136(GClass160 parentScr)
	{
		string_3 = string.Empty;
		gclass160_0 = parentScr;
		method_1();
	}
	...
	public GClass136(int x, int y, int w, int h)
	{
		string_3 = string.Empty;
		method_1();
		int_0 = x;
	...
	public GClass136(string text, int maxLen, int inputType)
	{
		string_3 = text;
		int_17 = maxLen;
		int_23 = inputType;
	...
	{
		int_6 = GClass160.int_0 + 1;
		gclass118_0 = new GClass118(mResources.DELETE, this, 1000, null);
		if (Main.isPC)
			int_4 = 0;
		if (gclass20_0 == null)
			gclass20_0 = GClass14.smethod_43("/mainImage/myTexture2dtf.png");
	}
	...
	{
		if (string_5 == null || GClass104.gclass104_21 == null)
			return;
		if (int_23 != int_13)
			string_5 = string_3;
		else
			string_5 = string_4;
		if (int_18 < 0 && GClass104.gclass104_21.method_17(string_5) + int_18 < int_2 - int_9 - 13 - int_24)
			int_18 = int_2 - 10 - int_24 - GClass104.gclass104_21.method_17(string_5);
		if (int_18 + GClass104.gclass104_21.method_17(string_5.Substring(0, int_15)) > 0)
		{
			if (int_18 + GClass104.gclass104_21.method_17(string_5.Substring(0, int_15)) >= int_2 - 12 - int_24)
				int_18 = int_2 - 10 - int_24 - GClass104.gclass104_21.method_17(string_5.Substring(0, int_15)) - 2 * int_9;
		}
		else
		{
			int_18 = -GClass104.gclass104_21.method_17(string_5.Substring(0, int_15));
			int_18 += 40;
		}
		if (int_18 > 0)
			int_18 = 0;
	...
	private void method_7(int int_40)
	{
		...
		if (int_40 == int_19)
		{
			...
			string text = string_3.Substring(0, int_15 - 1) + obj;
		...
		else if (string_3.Length < int_17)
		{
			...
			string text2 = string_3.Substring(0, int_15) + obj;
			if (int_15 < string_3.Length)
	...
	private void method_8(int int_40)
	{
		...
		if (string_3.Length < int_17)
		{
			...
			string_3 = text2;
			GClass45.smethod_0().method_3(ref string_3, int_23, int_15, (char)int_40);
	...
	public bool method_10(int keyCode)
	{
		if (!Main.isPC || keyCode != -8)
		{
			...
			if (keyCode != int_33 || int_23 != int_11)
			{
				...
				else if (int_23 != int_11 && int_23 != int_13 && int_23 != int_14)
				{
					if (int_23 == int_12)
					{
						method_8(keyCode);
	...
	public void method_11(int index)
	{
		if (int_23 != int_13)
			...
			string_5 = string_4;
		int num = GClass104.gclass104_21.method_17(string_5.Substring(0, int_15));
		if (index != -1)
		{
			if (index != 1)
				int_18 = -(num - (int_2 - 12));
			...
			{
				int_18 -= GClass104.gclass104_21.method_17(string_5.Substring(int_15 - 1, 1));
			}
		}
		else if (num + int_18 < 15 && int_15 > 0 && int_15 < string_5.Length)
		{
			int_18 += GClass104.gclass104_21.method_17(string_5.Substring(int_15, 1));
		}
		if (int_18 > 0)
			int_18 = 0;
		else if (int_18 < 0)
		{
			int num2 = GClass104.gclass104_21.method_17(string_5) - (int_2 - 12);
			if (int_18 < -num2)
				int_18 = -num2;
		}
	}

	public void method_12(GClass193 g, bool iss, int x, int y, int w, int h, int xText, int yText, string text, string info)
	{
		g.method_16(0);
		if (iss)
		{
			g.method_23(gclass20_0, 0, 81, 29, 27, 0, x, y, 0);
			g.method_23(gclass20_0, 0, 135, 29, 27, 0, x + w - 29, y, 0);
			g.method_23(gclass20_0, 0, 108, 29, 27, 0, x + w - 58, y, 0);
			for (int i = 0; i < (w - 58) / 29; i++)
			{
				g.method_23(gclass20_0, 0, 108, 29, 27, 0, x + 29 + i * 29, y, 0);
			}
		}
		else
		{
			g.method_23(gclass20_0, 0, 0, 29, 27, 0, x, y, 0);
			g.method_23(gclass20_0, 0, 54, 29, 27, 0, x + w - 29, y, 0);
			g.method_23(gclass20_0, 0, 27, 29, 27, 0, x + w - 58, y, 0);
			for (int j = 0; j < (w - 58) / 29; j++)
			{
				g.method_23(gclass20_0, 0, 27, 29, 27, 0, x + 29 + j * 29, y, 0);
			}
		}
		...
		if (text == null || text.Equals(string.Empty))
		{
			...
			{
				if (iss)
					GClass104.gclass104_9.method_6(g, info, xText, yText, 0);
				else
					GClass104.gclass104_10.method_6(g, info, xText, yText, 0);
			}
		}
		else
			GClass104.gclass104_21.method_6(g, text, xText, yText, 0);
	}
	...
	public void method_13(GClass193 g)
	{
		...
		if (int_23 == int_13)
			...
			string_5 = string_3;
		method_12(g, flag, int_0, int_1 - 1, int_2, int_3 + 5, int_9 + int_18 + int_0 + 1, int_1 + (int_3 - GClass104.gclass104_21.method_20()) / 2 + 2, string_5, string_7);
		...
		if (flag && bool_6 && bool_7)
		{
			...
			{
				g.method_16(7999781);
				g.method_15(int_9 + 1 + int_18 + int_0 + GClass104.gclass104_21.method_17(string_5.Substring(0, int_15) + "a") - int_7 - GClass104.gclass104_21.method_17("a"), int_1 + (int_3 - int_6) / 2 + 5, int_7, int_6);
			}
			GClass14.smethod_6(g);
			if (string_3 != null && string_3.Length > 0 && GClass14.bool_5)
				g.method_31(GClass14.gclass20_7, int_0 + int_2 - 13, int_1 + int_3 / 2 + 3, GClass193.int_1 | GClass193.int_0);
		}
	}
	...
	public void method_17()
	{
		...
		if (gclass196_0 != null && gclass136_0 == this)
		{
			if (gclass196_0.string_0.Length < 40 && bool_0)
				method_23(gclass196_0.string_0);
			if (gclass196_0.bool_2 && gclass118_1 != null)
	...
	{
		if (!GClass14.smethod_24(int_0 + int_2 - 20, int_1, 40, int_3))
		{
			if (!GClass14.smethod_24(int_0, int_1, int_2 - 20, int_3))
				method_19(false);
			else
				method_20(true);
		}
	...
	public void method_19(bool isFocus)
	{
		...
		if (isFocus)
		{
			gclass136_0 = this;
			if (gclass196_0 != null)
				gclass196_0.string_0 = gclass136_0.string_3;
		}
	}
	...
	public void method_20(bool isFocus)
	{
		...
		if (isFocus)
			gclass136_0 = this;
		else if (gclass136_0 == this)
		{
			gclass136_0 = null;
		}
		if (Thread.CurrentThread.Name == Main.mainThreadName && gclass136_0 != null)
		{
			isFocus = true;
			GClass196.bool_0 = !gclass136_0.bool_8;
			GEnum2 t = GEnum2.const_1;
			if (int_23 == int_12)
				t = GEnum2.const_2;
			bool type = false;
			if (int_23 == int_13)
				type = true;
			gclass196_0 = GClass196.smethod_0(gclass136_0.string_3, t, false, false, type, false, gclass136_0.string_7);
			if (gclass196_0 != null)
				gclass196_0.string_0 = gclass136_0.string_3;
			GClass92.smethod_5("SHOW KEYBOARD FOR " + gclass136_0.string_3);
		}
	}
